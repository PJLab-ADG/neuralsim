...
@brief  Appearance evaluation evaluation on a multi-object scene.
"""
import os
import sys
        ...
        for frame_ind in tqdm(range(args.start_frame, args.stop_frame or len(scene), 1), "rendering frames..."):
            ...
            for cam_id in cam_id_list:
                ...
                ret = renderer.render(
                    ...
                    render_per_obj_individual=True, render_per_obj_in_scene=False)
...
def make_parser():
    ...
    bc.parser.add_argument("--rayschunk", type=int, default=8192, help="Chunkify the rendering process.")
