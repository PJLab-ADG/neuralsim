"""
@file   manipulate_directory.py
@author Jianfei Guo, Shanghai AI Lab
@brief  Scene editing for all exps in a specified directory (--overall_dir)
"""
import os
import sys
...
from code_multi.tools.manipulate import main_function as manipulate_main, make_parser as manipulate_parser
...
def main_function(args: ConfigDict):
    ...
    for sdirname in tqdm(sdir_list, 'evaluating...'):
        ...
        if os.path.isdir(full_sdir):
            ...
            try:
                manipulate_main(sargs)
            except FileExistsError:
                pass

if __name__ == "__main__":
    bc = manipulate_parser()
