"""
@file   eval_lidar_directory.py
@author Jianfei Guo, Shanghai AI Lab
@brief  LiDAR evaluation for all exps in a specified directory (--overall_dir)
"""
import os
import sys
...
from code_single.tools.eval_lidar import main_function as eval_lidar_main, make_parser as eval_lidar_parser
...
def main_function(args: ConfigDict):
    ...
    for sdirname in tqdm(sdir_list, 'evaluating...'):
        ...
        if os.path.isdir(full_sdir):
            ...
            try:
                eval_lidar_main(sargs)
            except FileExistsError:
                pass

if __name__ == "__main__":
    bc = eval_lidar_parser()
